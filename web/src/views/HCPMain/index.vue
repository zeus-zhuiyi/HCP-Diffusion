<template>
  <div class="home-wrapper">
    <div class="nav-wrap">
      ...
      <p @click="copyText($store.state.generate_sn)" style="margin-bottom: 15px">
        generate_sn: {{ $store.state.generate_sn }}
      </p>
      <p @click="copyText($store.state.pt_sn)" style="margin-bottom: 15px">
        pt_sn: {{ $store.state.pt_sn }}
      </p>
      <p @click="copyText($store.state.dataset_sn)" style="margin-bottom: 15px">
        dataset_sn: {{ $store.state.dataset_sn }}
      </p>
      <p @click="copyText($store.state.train_sn)" style="margin-bottom: 15px">
        train_sn: {{ $store.state.train_sn }}
      </p>
      <div
        class="nav-item"
        v-for="nav in navs"
