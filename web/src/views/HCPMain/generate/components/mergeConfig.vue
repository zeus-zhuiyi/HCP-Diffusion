        ...
        <el-carousel-item v-for="(item, groupKey) in config" :key="groupKey">
          ...
          >
            <template>
              ...
              <!-- lora -->
              <HBlock label="lora" :h-index="3" showAdd @onAdd="addMergeGroupLoraConfig(groupKey)">
                <div
                ...
                >
                  ...
                  <div class="config-row">
                    <HConfigInput label="layers" v-model="lora_item.layers" />
                  </div>
                  <div class="config-row">
                    <HConfigSelect
                      label="mask"
              ...
              <!-- part -->
              <HBlock label="part" :h-index="3" showAdd @onAdd="addMergeGroupPartConfig(groupKey)">
                <div
                  class="block-style-item"
                ...
                >
                  <div class="config-row">
                    ...
                    />
                    <HConfigInput label="alpha" v-model="part_item.alpha" />
                  </div>
                  <i
                    style="color: red"
                    class="icon el-icon-delete"
                ...
                <template v-if="item.plugin">
                  ...
                  >
                    <div class="config-row" v-if="plugin_item.controlnet1">
                      ...
                      />
                      <HConfigInput label="layers" v-model="plugin_item.controlnet1.layers" />
                    </div>
                    <i
                      style="color: red"
                      class="icon el-icon-delete"
