<template>
  <h-collapse title="Offload Config" showSwitch v-model="isOpenOffloadConfig">
    <HBlock>
      <template v-if="config">
        ...
        <div class="config-row">
          <HConfigInput label="max_VRAM" v-model="config.max_VRAM" />
          <HConfigInput label="max_RAM" v-model="config.max_RAM" />
        </div>
      </template>
    </HBlock>
  </h-collapse>
