<template lang="">
  <h-collapse title="Infer_args Config" ref="collapseRef">
    <HBlock>
      <div class="config-row">
        <HConfigRange label="width" :min="128" :max="2048" :step="8" v-model="config.width" />
        <HConfigRange label="height" :min="128" :max="2048" :step="8" v-model="config.height" />
      </div>
      <div class="config-row">
        <HConfigRange
      ...
      <div class="config-row" v-if="isi2i">
        <HConfigRange label="strength" :min="0" :max="1" :step="0.01" v-model="config.strength" />
      </div>
    </HBlock>
  </h-collapse>
</template>
